package com.adatao.ddf.spark.analytics

import com.adatao.ddf.analytics.{IAlgorithmOutputModel, IParameters, AAlgorithm, IAlgorihtm}
...
class KmeansParameters(val numCentroids: Int= 5,
                       val maxIter: Int= 100,
                       val runs: Int= 10,
