 ...
 */
public class HBaseDDFManager extends DDFManager {
  ...
  public DDF loadTable(String tableName, String fieldSeparator) throws DDFException {
...
//       System.getenv(sparkHome), JavaSparkContext.jarOfClass(Simple.class));

  RDD<Tuple2<ImmutableBytesWritable, Result>> hBaseRDD  = getSparkContext().newAPIHadoopRDD( config, TableInputFormat.class,
          ImmutableBytesWritable.class, Result.class);
  
  long a = hBaseRDD.count();
