...
public class Schema implements Serializable {
  ...
  public void generateDummyCoding() throws NumberFormatException, DDFException {
    ...
    while (it.hasNext()) {
      ...
      // loop
      System.out.println(">>>>>>>>> looping inside generate dc: " + currentColumn.getName() + "\t"
          + currentColumn.getColumnClass());

      if (currentColumn.getColumnClass() == ColumnClass.FACTOR) {

        System.out.println(">>>>>>>>>>>> generateDummyCoding currentColumn\t" + currentColumn.getName() + "\t"
            + currentColumn.getColumnClass());
