...
class RegressionSuite extends ABigRClientTest {
  ...
  test("Multiple-variable linear regression - normal equation - no regularization") {
    ...
    assertEquals(37.22727, model.weights(0), 0.01)
    assertEquals(-0.031773, model.weights(1), 0.01)
    assertEquals(-3.877831, model.weights(2), 0.01)
    assertEquals(1.598788, model.stdErrs(0), 0.01)
    assertEquals(0.00903, model.stdErrs(1), 0.01)
    assertEquals(0.632733, model.stdErrs(2), 0.01)
    assertEquals(195.047755, model.rss, 0.01)
    assertEquals(1126.047188, model.sst, 0.01)
    assertEquals(1.766625, model.vif(0), 0.01)
    assertEquals(1.766625, model.vif(1), 0.01)
