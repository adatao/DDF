...
object GetMultiFactor {
  ...
  class MultiFactorReducer
    extends Function2[JMap[Int, JMap[String, JInt]], JMap[Int, JMap[String, JInt]], JMap[Int, JMap[String, JInt]]]
    with Serializable {
    @Override
    def apply(map1: JMap[Int, JMap[String, JInt]], map2: JMap[Int, JMap[String, JInt]]): JMap[Int, JMap[String, JInt]] = {
      for ((idx, smap1) <- map1) {
